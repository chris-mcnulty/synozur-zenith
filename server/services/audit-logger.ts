...
export const AUDIT_ACTIONS = {
  ...
  TENANT_HEALTH_DEGRADED: "TENANT_HEALTH_DEGRADED",
  TENANT_HEALTH_RECOVERED: "TENANT_HEALTH_RECOVERED",
  ...
  LIBRARY_LABEL_DEFAULT_SET: "apply_library_default_label",
  LIBRARY_LABEL_DEFAULT_RETRO: "apply_library_default_label_retro",
  LIBRARY_LABEL_DEFAULT_SYNCED: "sync_library_default_labels",
  BULK_ACTION_APPLIED: "BULK_ACTION_APPLIED",
  ...
  LIFECYCLE_SCAN_STARTED: "LIFECYCLE_SCAN_STARTED",
  LIFECYCLE_SCAN_COMPLETED: "LIFECYCLE_SCAN_COMPLETED",
  LIFECYCLE_SCAN_FAILED: "LIFECYCLE_SCAN_FAILED",
  LIFECYCLE_REMEDIATION_OWNER_EMAILED: "LIFECYCLE_REMEDIATION_OWNER_EMAILED",
