...
const GRAPH_PERMISSIONS = [
  ...
  { name: "AiEnterpriseInteraction.Read.All", description: "Copilot Prompt Intelligence (BL-038) — read M365 Copilot user interactions (Professional+ plan). Add via app manifest if not visible in the Entra permissions picker." },
];
